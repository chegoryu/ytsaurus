...
from .file_commands import LocalFile as YLocalFile
...
from .schema.table_schema import SortColumn
from .schema.types import YtDataclassType
from .operation_commands import Operation, OperationState
from .response_stream import ResponseStream
from .dynamic_table_commands import BackupManifest
...
class YtClient(ClientState):
    ...
    def __init__(self, proxy: str | None = None, token: str | None = None, config: dict[str, Any] | None = None):
        super(YtClient, self).__init__()
        initialize_client(self, proxy, token, config)

    def LocalFile(self, path: TPath, file_name: str | None = None, attributes: TAttributes | None = None) -> YLocalFile:
        """
    ...
    def PingTransaction(
        ...
        return client_api.PingTransaction(
            transaction, ping_period, ping_timeout, client=self, interrupt_on_failed=interrupt_on_failed
        )

    def TablePath(
        self,
        name: TPath | TTablePath,
    ...
    def TempTable(
        ...
        """
        return client_api.TempTable(path, prefix, attributes, expiration_timeout, client=self)
    ...
    def abort_job(self, job_id: str, interrupt_timeout: int | None = None):
        """
    ...
    def abort_operation(self, operation: str, reason: str | None = None):
        """
        Aborts operation.
    ...
    def abort_query(self, query_id: str, message: str | None = None, stage: str | None = None):
        """
        Abort query.
        ...
        """
        return client_api.abort_query(query_id, client=self, message=message, stage=stage)

    def abort_transaction(self, transaction: str):
        """
    ...
    def add_maintenance(self, component: str, address: str, type: str, comment: str):
        """
        ...
        per target.
        """
        return client_api.add_maintenance(component, address, type, comment, client=self)

    def add_member(self, member: str, group: str):
        """
    ...
    def advance_consumer(
        self,
        consumer_path: TTablePath,
        queue_path: TTablePath,
        partition_index: int,
        old_offset: int | None,
        new_offset: int,
        ...
        return client_api.advance_consumer(
            consumer_path, queue_path, partition_index, old_offset, new_offset, client_side, client=self
        )
    ...
    def advance_queue_consumer(
        ...
        return client_api.advance_queue_consumer(
            consumer_path, queue_path, partition_index, old_offset, new_offset, client=self, client_side=client_side
        )
    ...
    def alter_query(
        ...
        return client_api.alter_query(
            query_id, client=self, stage=stage, annotations=annotations, access_control_objects=access_control_objects
        )

    def alter_replication_card(
        self,
        replication_card_id: str,
        replicated_table_options: dict[str, Any] | None = None,
        enable_replicated_table_tracker: bool | None = None,
        replication_card_collocation_id: str | None = None,
    ):
        """
    ...
    def alter_table(
        ...
        upstream_replica_id: str | None = None,
        replication_progress: dict[str, Any] | None = None,
    ):
        """
        ...
        return client_api.alter_table(
            ...
            schema_id=schema_id,
            dynamic=dynamic,
            upstream_replica_id=upstream_replica_id,
    ...
    def balance_tablet_cells(self, bundle: str, tables: list[Any] | None = None, sync: bool = False):
        """
    ...
    def batch_apply(self, function: Callable[..., Any], data: Any):
        """
    ...
    def commit_transaction(self, transaction: str):
        """
    ...
    def concatenate(self, source_paths: list[TPath], destination_path: TPath):
        """
    ...
    def copy(
        self,
        source_path: TPath,
        destination_path: TPath,
        recursive: bool | None = None,
        force: bool | None = None,
        ignore_existing: bool | None = None,
        lock_existing: bool | None = None,
        preserve_account: bool | None = None,
        preserve_owner: bool | None = None,
        preserve_acl: bool | None = None,
        preserve_expiration_time: bool | None = None,
        preserve_expiration_timeout: bool | None = None,
        preserve_creation_time: bool | None = None,
        preserve_modification_time: bool | None = None,
        pessimistic_quota_check: bool | None = None,
        enable_cross_cell_copying: bool | None = None,
    ):
        """
        Copies Cypress node.
        ...
        return client_api.copy(
            ...
            preserve_expiration_timeout=preserve_expiration_timeout,
            preserve_creation_time=preserve_creation_time,
            preserve_modification_time=preserve_modification_time,
            pessimistic_quota_check=pessimistic_quota_check,
            enable_cross_cell_copying=enable_cross_cell_copying,
        )
    ...
    def create_batch_client(
        self, raise_errors: bool = False, max_batch_size: int | None = None, concurrency: int | None = None
    ):
        """
        Creates client which supports batch executions.
        """
        return client_api.create_batch_client(
            client=self, raise_errors=raise_errors, max_batch_size=max_batch_size, concurrency=concurrency
        )

    def create_revision_parameter(self, path: TPath, transaction_id: str | None = None, revision: int | None = None):
        """
    ...
    def create_table(self, path: TTablePath, recursive: bool = False, ignore_existing: bool = False, *args, **kwargs):
        """
        ...
        return client_api.create_table(
            path, *args, client=self, recursive=recursive, ignore_existing=ignore_existing, **kwargs
        )
    ...
    def create_table_backup(
        ...
        force: bool | None = None,
        checkpoint_timestamp_delay: int | None = None,
        checkpoint_check_timeout: int | None = None,
        preserve_account: bool | None = None,
    ):
        """
    ...
    def delete_rows(
        ...
        format: TFormat | None = None,
        raw: bool | None = None,
        require_sync_replica: bool | None = None,
    ):
        """
    ...
    def destroy_chunk_locations(self, node_address: str, location_uuids: list[str]):
        """
        ...
        """
        return client_api.destroy_chunk_locations(node_address, location_uuids, client=self)

    def disable_chunk_locations(self, node_address: str, location_uuids: list[str]):
        """
        ...
        """
        return client_api.disable_chunk_locations(node_address, location_uuids, client=self)

    def download_core_dump(
        self,
        output_directory: TPath,
        job_id: str | None = None,
        operation_id: str | None = None,
        core_table_path: TTablePath | None = None,
        core_indices=None,
    ):
        """
    ...
    def dump_job_context(self, job_id: str, path: TPath):
        """
        Dumps job input context to specified path.
        """
        return client_api.dump_job_context(job_id, path, client=self)

    def dump_parquet(self, table: TTablePath, output_file: str):
        """
        ...
        """
        return client_api.dump_parquet(table, output_file, client=self)

    def execute_batch(self, requests: list[Any], concurrency: int | None = None):
        """
    ...
    def exists(
        ...
        suppress_transaction_coordinator_sync: bool | None = None,
    ) -> bool:
        """
    ...
    def explain_query(
        ...
        input_row_limit: int | None = None,
        output_row_limit: int | None = None,
        range_expansion_limit: int | None = None,
        max_subqueries: int | None = None,
        workload_descriptor=None,
        allow_full_scan: bool | None = None,
        allow_join_without_index: bool | None = None,
        format: TFormat | None = None,
        raw: bool | None = None,
        execution_pool: str | None = None,
        retention_timestamp: int | None = None,
    ):
        """
    ...
    def externalize(self, path: TPath, cell_tag: int):
        """
    ...
    def find_free_subpath(self, path: TPath) -> str:
        """
    ...
    def find_spark_cluster(self, discovery_path: TPath | None = None):
        """
        Print Spark urls
    ...
    def freeze_table(
        self,
        path: TTablePath,
        first_tablet_index: int | None = None,
        last_tablet_index: int | None = None,
        sync: bool = False,
    ):
        """
        Freezes the table.
        ...
        return client_api.freeze_table(
            path, client=self, first_tablet_index=first_tablet_index, last_tablet_index=last_tablet_index, sync=sync
        )
    ...
    def get(
        ...
        cache_sticky_group_size: int | None = None,
        suppress_transaction_coordinator_sync: bool | None = None,
        suppress_upstream_sync: bool | None = None,
    ) -> YsonMap:
        """
    ...
    def get_file_from_cache(self, md5: str, cache_path: TPath | None = None):
        """
    ...
    def get_flow_view(
        ...
        """
        return client_api.get_flow_view(pipeline_path, client=self, view_path=view_path, format=format)
    ...
    def get_in_sync_replicas(
        ...
        all_keys: bool = False,
        cached_sync_replicas_timeout: int | None = None,
        format: TFormat | None = None,
        raw: bool | None = None,
    ):
        """
    ...
    def get_job(self, operation_id: str, job_id: str, format: TFormat | None = None) -> YsonMap:
        """
    ...
    def get_job_input(self, job_id: str) -> ResponseStream:
        """
    ...
    def get_job_input_paths(self, job_id: str) -> list[YPath]:
        """
    ...
    def get_job_spec(
        self,
        job_id: str,
        omit_node_directory: bool | None = None,
        omit_input_table_specs: bool | None = None,
        omit_output_table_specs: bool | None = None,
    ) -> YsonMap:
        """
        ...
        return client_api.get_job_spec(
            job_id,
            client=self,
            omit_node_directory=omit_node_directory,
            omit_input_table_specs=omit_input_table_specs,
            omit_output_table_specs=omit_output_table_specs,
        )

    def get_job_stderr(self, operation_id: str, job_id: str) -> ResponseStream:
        """
    ...
    def get_operation_attributes(self, operation: str, fields: list[str] | None = None) -> YsonMap:
        """
    ...
    def get_operation_state(self, operation: str) -> OperationState:
        """
    ...
    def get_pipeline_dynamic_spec(
        ...
        """
        return client_api.get_pipeline_dynamic_spec(pipeline_path, client=self, spec_path=spec_path, format=format)
    ...
    def get_pipeline_spec(
        ...
        """
        return client_api.get_pipeline_spec(pipeline_path, client=self, spec_path=spec_path, format=format)
    ...
    def get_pipeline_state(
        ...
        """
        return client_api.get_pipeline_state(pipeline_path, client=self)
    ...
    def get_query(
        ...
        """
        return client_api.get_query(query_id, client=self, attributes=attributes, stage=stage, format=format)

    def get_query_result(
        self, query_id: str, result_index: int | None = None, stage: str | None = None, format: TFormat | None = None
    ) -> YsonMap:
        """
        Get query result.
        ...
        :type stage: str
        """
        return client_api.get_query_result(query_id, client=self, result_index=result_index, stage=stage, format=format)

    def get_supported_features(self, format: TFormat | None = None):
        """
    ...
    def get_table_columnar_statistics(self, paths: list[TTablePath]):
        """
    ...
    def get_table_schema(self, table_path: TTablePath):
        """
    ...
    def get_tablet_errors(self, path: TTablePath, limit: int | None = None, format: TFormat | None = None):
        """
    ...
    def get_tablet_infos(self, path: TTablePath, tablet_indexes: list[str], format: TFormat | None = None):
        """
    ...
    def get_type(self, path: TPath, *args, **kwargs):
        """
        ...
        """
        return client_api.get_type(path, *args, client=self, **kwargs)

    def get_user_name(self, token: str | None = None, headers=None):
        """
    ...
    def has_attribute(self, path: TPath, attribute: str):
        """
    ...
    def internalize(self, path: TPath):
        """
    ...
    def is_empty(self, table: TTablePath) -> bool:
        """
        Is table empty?
    ...
    def is_sorted(self, table: TTablePath) -> bool:
        """
        Is table sorted?
    ...
    def issue_token(self, user: str, password: str | None = None):
        """
        Issues a new token for user.
        """
        return client_api.issue_token(user, client=self, password=password)
    ...
    def iterate_operations(
        ...
        pool: str | None = None,
        with_failed_jobs: bool | None = None,
        from_time: int | None = None,
        to_time: int | None = None,
        cursor_direction: str = 'past',
    ...
    def list(
        ...
        return client_api.list(
            ...
            cache_sticky_group_size=cache_sticky_group_size,
            suppress_transaction_coordinator_sync=suppress_transaction_coordinator_sync,
            supress_upstream_sync=suppress_upstream_sync,
        )
    ...
    def list_jobs(
        ...
        address=None,
        job_competition_id: str | None = None,
        with_competitors: bool | None = None,
        sort_field=None,
        sort_order=None,
        limit: int | None = None,
        offset: int | None = None,
        with_stderr: bool | None = None,
        with_spec: bool | None = None,
        with_fail_context: bool | None = None,
        with_monitoring_descriptor: bool | None = None,
        include_cypress: bool | None = None,
        ...
        return client_api.list_jobs(
            ...
            with_spec=with_spec,
            with_fail_context=with_fail_context,
            with_monitoring_descriptor=with_monitoring_descriptor,
            include_cypress=include_cypress,
    ...
    def list_operations(
        ...
        include_archive: bool | None = None,
        include_counters: bool | None = None,
        limit: int | None = None,
    ...
    def list_queue_consumer_registrations(
        self,
        queue_path: TTablePath | None = None,
        consumer_path: TTablePath | None = None,
        format: TFormat | None = None,
    ):
        """
        ...
        return client_api.list_queue_consumer_registrations(
            client=self, queue_path=queue_path, consumer_path=consumer_path, format=format
        )

    def list_user_tokens(self, user: str, password: str | None = None):
        """
        Lists sha256-encoded user tokens.
        """
        return client_api.list_user_tokens(user, client=self, password=password)
    ...
    def lookup_rows(
        ...
        keep_missing_rows: bool | None = None,
        enable_partial_result: bool | None = None,
        use_lookup_cache: bool | None = None,
        format: TFormat | None = None,
        raw: bool | None = None,
        ...
        return client_api.lookup_rows(
            ...
            enable_partial_result=enable_partial_result,
    ...
    def mkdir(self, path: TPath, recursive: bool | None = None):
        """
    ...
    def mount_table(
        ...
        freeze: bool = False,
        sync: bool = False,
        target_cell_ids: list[str] | None = None,
    ):
        """
        Mounts the table.
    ...
    def partition_tables(
        self,
        paths: list[TTablePath],
        partition_mode: TPartitionMode | None = None,
        data_weight_per_partition: int | None = None,
        max_partition_count: int | None = None,
        enable_key_guarantee: bool | None = None,
        adjust_data_weight_per_partition: bool | None = None,
    ):
        """
        ...
        return client_api.partition_tables(
            ...
            adjust_data_weight_per_partition=adjust_data_weight_per_partition,
        )

    def pause_pipeline(self, pipeline_path: TPath):
        """
        ...
        """
        return client_api.pause_pipeline(pipeline_path, client=self)

    def ping_transaction(
        self, transaction: str, timeout: int | None = None, retry_config: dict[str, Any] | None = None
    ):
        """
    ...
    def pull_consumer(
        ...
        max_data_weight: int | None = None,
        replica_consistency: TReplicaConsistency | None = None,
        format: TFormat | None = None,
        raw: bool | None = None,
    ):
        """
        ...
        return client_api.pull_consumer(
            ...
            max_data_weight=max_data_weight,
    ...
    def put_file_to_cache(self, path: TPath, md5: str, cache_path: str | None = None):
        """
        Puts file to cache
    ...
    def read_blob_table(
        self,
        table: TTablePath,
        part_index_column_name: str | None = None,
        data_column_name: str | None = None,
        part_size: int | None = None,
        table_reader: TTableReaderSpec | None = None,
    ):
        """
    ...
    def read_file(
        self,
        path: TPath,
        file_reader: TFileReaderSpec | None = None,
        offset: int | None = None,
    ...
    def read_query_result(
        ...
        return client_api.read_query_result(
            query_id, client=self, result_index=result_index, stage=stage, format=format, raw=raw
        )
    ...
    def read_table_structured(
        self,
        table: TTablePath,
        row_type: Type[YtDataclassType],
        table_reader: TTableReaderSpec | None = None,
        unordered: bool | None = None,
        response_parameters=None,
        enable_read_parallel: bool | None = None,
    ) -> Iterable[YtDataclassType]:
        """
    ...
    def register_queue_consumer(self, queue_path: TTablePath, consumer_path: TTablePath, vital: bool, partitions=None):
        """
        ...
        """
        return client_api.register_queue_consumer(queue_path, consumer_path, vital, client=self, partitions=partitions)

    def remount_table(
        self, path: TTablePath, first_tablet_index: int | None = None, last_tablet_index: int | None = None
    ):
        """
        Remounts the table.
        ...
        return client_api.remount_table(
            path, client=self, first_tablet_index=first_tablet_index, last_tablet_index=last_tablet_index
        )

    def remove(self, path: TPath, recursive: bool = False, force: bool = False):
        """
    ...
    def remove_attribute(self, path: TPath, attribute: str):
        """
    ...
    def remove_maintenance(
        ...
        return client_api.remove_maintenance(
            component, address, client=self, id=id, ids=ids, type=type, user=user, mine=mine, all=all
        )

    def remove_member(self, member: str, group: str):
        """
    ...
    def remove_pipeline_dynamic_spec(
        ...
        return client_api.remove_pipeline_dynamic_spec(
            pipeline_path, client=self, spec_path=spec_path, expected_version=expected_version
        )
    ...
    def remove_pipeline_spec(
        ...
        return client_api.remove_pipeline_spec(
            pipeline_path, client=self, spec_path=spec_path, expected_version=expected_version, force=force
        )

    def reshard_table(
        self,
        path: TTablePath,
        pivot_keys: list[str] | None = None,
        tablet_count: int | None = None,
        first_tablet_index: int | None = None,
        last_tablet_index: int | None = None,
        uniform=None,
        enable_slicing: bool | None = None,
    ...
    def reshard_table_automatic(self, path: TTablePath, sync: bool = False):
        """
    ...
    def restore_table_backup(self, manifest, force=None, mount=None, enable_replicas=None, preserve_account=None):
        """
    ...
    def resume_operation(self, operation: str):
        """
    ...
    def resurrect_chunk_locations(self, node_address: str, location_uuids: list[str]):
        """
        ...
        """
        return client_api.resurrect_chunk_locations(node_address, location_uuids, client=self)

    def revoke_token(
        self, user: str, password: str | None = None, token: str | None = None, token_sha256: str | None = None
    ):
        """
        Revokes user token.
        """
        return client_api.revoke_token(user, client=self, password=password, token=token, token_sha256=token_sha256)

    def row_count(self, table: TTablePath) -> int:
        """
    ...
    def run_command_with_lock(
        ...
        popen_kwargs=None,
        lock_conflict_callback=None,
        ping_failed_callback=None,
        set_address=True,
        address_path=None,
        create_lock_options=None,
        poll_period=None,
        ...
        return client_api.run_command_with_lock(
            ...
            lock_conflict_callback=lock_conflict_callback,
            ping_failed_callback=ping_failed_callback,
            set_address=set_address,
            address_path=address_path,
            create_lock_options=create_lock_options,
    ...
    def run_join_reduce(
        self,
        binary: str | TReducer,
        source_table: TTablePath | list[TTablePath],
        destination_table: TTablePath | list[TTablePath],
        local_files: str | YLocalFile | list[str] | list[YLocalFile] | None = None,
        yt_files: TPath | list[TPath] | None = None,
        format: TFormat | None = None,
        input_format: TFormat | None = None,
        output_format: TFormat | None = None,
        sync: bool = True,
        job_io: TJobIOSpec | None = None,
        table_writer: TTableWriterSpec | None = None,
        job_count: int | None = None,
        memory_limit: int | None = None,
        spec: TSpec | None = None,
        sort_by: str | SortColumn | list[str] | list[SortColumn] | None = None,
        reduce_by: str | SortColumn | list[str] | list[SortColumn] | None = None,
        join_by: str | SortColumn | list[str] | list[SortColumn] | None = None,
        stderr_table: TTablePath | None = None,
    ) -> Operation:
        """
    ...
    def run_map(
        ...
        binary: str | TMapper,
        source_table: TTablePath | list[TTablePath],
        destination_table: TTablePath | list[TTablePath] | None = None,
        local_files: str | YLocalFile | list[str] | list[YLocalFile] | None = None,
        yt_files: TPath | list[TPath] | None = None,
        format: TFormat | None = None,
        input_format: TFormat | None = None,
    ...
    def run_map_reduce(
        self,
        mapper: str | TMapper | None,
        reducer: str | TReducer | None,
        source_table: TTablePath | list[TTablePath],
        destination_table: TTablePath | list[TTablePath],
        format: TFormat | None = None,
        map_input_format: TFormat | None = None,
        map_output_format: TFormat | None = None,
        reduce_input_format: TFormat | None = None,
        reduce_output_format: TFormat | None = None,
        sync: bool = True,
        job_io: TJobIOSpec | None = None,
        table_writer: TTableWriterSpec | None = None,
        spec: TSpec | None = None,
        map_local_files: str | YLocalFile | list[str] | list[YLocalFile] | None = None,
        map_yt_files: TPath | list[TPath] | None = None,
        reduce_local_files: str | YLocalFile | list[str] | list[YLocalFile] | None = None,
        reduce_yt_files: TPath | list[TPath] | None = None,
        mapper_memory_limit: int | None = None,
        reducer_memory_limit: int | None = None,
        sort_by: str | SortColumn | list[str] | list[SortColumn] | None = None,
        reduce_by: str | SortColumn | list[str] | list[SortColumn] | None = None,
        reduce_combiner: TReducer | None = None,
        reduce_combiner_input_format: TFormat | None = None,
        reduce_combiner_output_format: TFormat | None = None,
        reduce_combiner_local_files: str | YLocalFile | list[str] | list[YLocalFile] | None = None,
        reduce_combiner_yt_files: TPath | list[TPath] | None = None,
        reduce_combiner_memory_limit: int | None = None,
        stderr_table: TTablePath | None = None,
    ) -> Operation:
        """
        ...
        return client_api.run_map_reduce(
            ...
            client=self,
            format=format,
            map_input_format=map_input_format,
            map_output_format=map_output_format,
            reduce_input_format=reduce_input_format,
            reduce_output_format=reduce_output_format,
            sync=sync,
            job_io=job_io,
            table_writer=table_writer,
            spec=spec,
            map_local_files=map_local_files,
            map_yt_files=map_yt_files,
            reduce_local_files=reduce_local_files,
            reduce_yt_files=reduce_yt_files,
            mapper_memory_limit=mapper_memory_limit,
            reducer_memory_limit=reducer_memory_limit,
            sort_by=sort_by,
            reduce_by=reduce_by,
            reduce_combiner=reduce_combiner,
            reduce_combiner_input_format=reduce_combiner_input_format,
            reduce_combiner_output_format=reduce_combiner_output_format,
            reduce_combiner_local_files=reduce_combiner_local_files,
            reduce_combiner_yt_files=reduce_combiner_yt_files,
            reduce_combiner_memory_limit=reduce_combiner_memory_limit,
            stderr_table=stderr_table,
        )
    ...
    def run_operation(
        ...
        spec_builder,
        sync: bool = True,
        run_operation_mutation_id: str | None = None,
        ...
        return client_api.run_operation(
            ...
            client=self,
            sync=sync,
            run_operation_mutation_id=run_operation_mutation_id,
    ...
    def run_remote_copy(
        ...
        copy_attributes: bool | None = None,
        spec: TSpec | None = None,
        sync: bool = True,
    ) -> Operation:
        """
        ...
        :type destination_table: str or :class:`TablePath <yt.wrapper.ypath.TablePath>`
        :param str cluster_name: source name.
    ...
    def run_sort(
        self,
        source_table: TTablePath | list[TTablePath],
        destination_table: TTablePath | None = None,
        sort_by: str | SortColumn | list[str] | list[SortColumn] | None = None,
        sync: bool = True,
        job_io: TJobIOSpec | None = None,
        table_writer: TTableWriterSpec | None = None,
    ...
    def sample_rows_from_table(self, table: TTablePath, output_table: TTablePath, row_count: int):
        """
    ...
    def search(
        ...
        object_filter=None,
        subtree_filter=None,
        map_node_order=_MapOrderSorted(),
        list_node_order: str | None = None,
        attributes: list[str] | None = None,
        ...
        read_from=None,
        cache_sticky_group_size: int | None = None,
        enable_batch_mode: bool | None = None,
    ):
        """
        ...
        return client_api.search(
            ...
            map_node_order=map_node_order,
            list_node_order=list_node_order,
            attributes=attributes,
            exclude=exclude,
    ...
    def select_rows(
        ...
        output_row_limit: int | None = None,
        range_expansion_limit: int | None = None,
        fail_on_incomplete_result: bool | None = None,
        verbose_logging: bool | None = None,
        enable_code_cache: bool | None = None,
        max_subqueries: int | None = None,
        workload_descriptor=None,
        allow_full_scan: bool | None = None,
        allow_join_without_index: bool | None = None,
        ...
        use_canonical_null_relations: int | None = None,
        merge_versioned_rows: bool | None = None,
        syntax_version: int | None = None,
        versioned_read_options: dict[str, Any] | None =None,
        ...
        return client_api.select_rows(
            ...
            use_canonical_null_relations=use_canonical_null_relations,
    ...
    def set_pipeline_dynamic_spec(
        ...
        return client_api.set_pipeline_dynamic_spec(
            pipeline_path, value, client=self, spec_path=spec_path, expected_version=expected_version, format=format
        )
    ...
    def set_user_password(self, user: str, new_password: str, current_password: str | None = None):
        """
        Updates user password.
        """
        return client_api.set_user_password(user, new_password, client=self, current_password=current_password)

    def shuffle_table(
        self, table: TTablePath, sync: bool = True, temp_column_name: str = '__random_number', spec: Any = None
    ):
        """
    ...
    def smart_upload_file(
        self,
        filename: str,
        destination: TPath | None = None,
        yt_filename: str | None = None,
        placement_strategy: str | None = None,
        ignore_set_attributes_error: bool = True,
        hash: str | None = None,
    ):
        """
        ...
        * "hash" (only if `destination` parameter is `None`) -> destination path will be
        ...
        return client_api.smart_upload_file(
            ...
            ignore_set_attributes_error=ignore_set_attributes_error,
            hash=hash,
        )

    def start_pipeline(self, pipeline_path: TPath):
        """
        ...
        """
        return client_api.start_pipeline(pipeline_path, client=self)
    ...
    def start_transaction(
        self,
        parent_transaction: str | None = None,
        timeout: int | None = None,
        deadline: int | None = None,
        attributes: TAttributes | None = None,
        type: Literal["master", "tablet"] = 'master',
    ...
    def stop_pipeline(self, pipeline_path: TPath):
        """
        ...
        """
        return client_api.stop_pipeline(pipeline_path, client=self)

    def suspend_operation(self, operation: str, abort_running_jobs: bool = False):
        """
        Suspends operation.
    ...
    def transfer_account_resources(self, source_account: str, destination_account: str, resource_delta: dict[str, Any]):
        """
    ...
    def trim_rows(self, path: TTablePath, tablet_index: int, trimmed_row_count: int):
        """
    ...
    def unregister_queue_consumer(self, queue_path: TTablePath, consumer_path: TTablePath):
        """
        ...
        """
        return client_api.unregister_queue_consumer(queue_path, consumer_path, client=self)

    def update_operation_parameters(self, operation_id: str, parameters: TSpec):
        """
        Updates operation runtime parameters.
        """
        return client_api.update_operation_parameters(operation_id, parameters, client=self)

    def upload_parquet(self, table: TTablePath, input_file: str):
        """
        ...
        """
        return client_api.upload_parquet(table, input_file, client=self)

    def write_file(
        self,
        destination: TPath,
        stream: Iterable[bytes],
        file_writer: TFileWriterSpec | None = None,
        is_stream_compressed: bool = False,
        force_create: bool | None = None,
        compute_md5: bool = False,
        size_hint: int | None = None,
        filename_hint: str | None = None,
        progress_monitor: bool | None = None,
    ):
        """
    ...
    def write_table_structured(
        ...
        table: TTablePath,
        row_type: Type[YtDataclassType],
        input_stream: Iterable[YtDataclassType],
        table_writer: TTableWriterSpec | None = None,
        max_row_buffer_size: int | None = None,
        force_create: bool | None = None,
    ):
